...
if (auth == undefined) {
    ...
    platform = JSON.parse(localStorage.getItem('settings'));
        ...
        function loadProductList() {
            ...
            products.forEach((product, index) => {
                ...
                product_list += `<tr>
                                    ...
                                    <td class="nobr"><span class="btn-group"><button onClick="$(this).editProduct(${index})" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></button><button onClick="$(this).deleteProduct(${product._id})" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></button></span></td>
                                </tr>`;
